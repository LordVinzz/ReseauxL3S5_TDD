...
void vers_reseau(paquet_t *paquet)
{
    ...
    {
        printf("%s[PHY] perte de paquet CON_REQ%s\n", RED, NRM);
    ...
    {
        printf("%s[PHY] perte de paquet CON_ACCEPT%s\n", RED, NRM);
        perte_connexion = 0; /* on ne perd qu'une fois */
        return;
    }
    ...
    {
        printf("%s[PHY] perte de paquet CON_CLOSE%s\n", RED, NRM);
    ...
    {
        printf("%s[PHY] perte de paquet CON_CLOSE_ACK%s\n", RED, NRM);
        perte_deconnexion = 0; /* on ne perd qu'une fois */
        return;
    }
