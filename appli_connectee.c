 ...
 */
void de_application_mode_c(int *service, unsigned char *donnees, int *taille_msg) {
 ...
 */
int vers_application_mode_c(int service, unsigned char *donnees, int taille_msg) {
    char nom_fichier[30];
